...
.. code-block:: bash
    ...
    $ git clone https://github.com/domdfcoding/photo-sort"
    > Cloning into 'photo-sort'...
...
The recommended way to build ``photo-sort`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
